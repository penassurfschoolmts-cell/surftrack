    ...
    <LangContext.Provider value={lang}>
      ...
      <div className="app">
        ...
        <div className="main">
          ...
          {page === "instructors"   && <InstructorsPage instructors={instructors} students={students} createInstructor={safe(createInstructor)} updateInstructor={safe(updateInstructor)} deleteInstructor={safe(deleteInstructor)} logInstructorSession={safe(logInstructorSession)} createEmployeeForInstructor={safe(createEmployeeForInstructor)} todayStr={todayStr} />}
...
// INSTRUCTORS PAGE
// ─────────────────────────────────────────────
function InstructorsPage({ instructors, students = [], createInstructor, updateInstructor, deleteInstructor, logInstructorSession, createEmployeeForInstructor, todayStr }) {
