...
function AdminDashboard({ user }) {
  ...
  const [campEnrollments, setCampEnrollments] = useState([]); // flat list of all enrollments
  const [campAttendance, setCampAttendance] = useState([]); // flat list of all attendance
  ...
  const loadCamps = useCallback(async () => {
    try {
      ...
      setCamps(campList);
      // Load all enrollments and attendance for all camps
  ...
  useEffect(() => { load(); loadReservations(); loadCamps(); }, [load, loadReservations, loadCamps]);
