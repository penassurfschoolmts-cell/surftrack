...
// STUDENT DETAIL MODAL
// ─────────────────────────────────────────────
function StudentDetailModal({ student, onClose, processEntry, logLesson, addPunches, setMembership, removeMembership, correctEntry, adjustPunchBalance, deleteStudent, sendWelcomeEmail, updateStudentDetails }) {
  const t = useLang();
  const { lessonTypes, groupClasses, tiers, cardOptions } = useConfig();
