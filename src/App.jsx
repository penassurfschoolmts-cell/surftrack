...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── SIDEBAR ───────────────────────────── */
  .sidebar { width: 236px; min-width: 236px; background: var(--surface);
    border-right: 1px solid var(--border); display: flex; flex-direction: column; padding: 24px 0;
    box-shadow: 2px 0 12px rgba(42,143,189,.07); }
  ...
  .nav-item { display: flex; align-items: center; gap: 10px; padding: 10px 20px; color: var(--muted); cursor: pointer; transition: all .15s; font-size: 13px; font-weight: 500; border-left: 3px solid transparent; }
...
function ReservationsPage({ students, reservations, lessonTypes, instructors = [], createReservation, cancelReservation, chargeNoShow, updateReservationInstructor, todayStr, getThisWeekMonday }) {
  const t = useLang();
