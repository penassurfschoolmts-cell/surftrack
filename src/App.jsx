...
// STUDENT DETAIL MODAL
// ─────────────────────────────────────────────
function StudentDetailModal({ student, onClose, processEntry, logLesson, addPunches, setMembership, removeMembership, correctEntry, adjustPunchBalance, adjustWeekSessions, activateMembership, deactivateMembership, activatePunchCard, deleteStudent, sendWelcomeEmail, updateStudentDetails }) {
  const t = useLang();
  const { lessonTypes, groupClasses, tiers, cardOptions } = useConfig();
