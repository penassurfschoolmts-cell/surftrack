  ...
  function getDateRange() {
    ...
    switch (preset) {
      ...
      case "last3months": {
        ...
        return { from, to: todayStr, label: "Last 3 months" };
      }
      case "last6months": {
        const from = new Date(y, m - 5, 1).toISOString().slice(0, 10);
        return { from, to: todayStr, label: "Last 6 months" };
      }
      case "allTime":
        return { from: null, to: null, label: "All data" };
      case "custom":
        return { from: customFrom || null, to: customTo || null, label: `${customFrom || "start"} → ${customTo || "today"}` };
      default:
        return { from: null, to: null, label: "All data" };
    }
  }
